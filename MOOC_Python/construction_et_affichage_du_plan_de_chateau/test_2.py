...
def tracer_case(case, couleur, pas): #fonction de traçage de carré d'une couleur
    turtle.hideturtle()
    turtle.speed(0)
    turtle.penup()
...
# Elle gère l'affichage général à l'aide de sa propre tortue (efface l'ancienne donnée affichée pour afficher la suivante
    ...
    turtle.down()
    turtle.write(texte, font = ("Verdana", 14, "normal"))
...
afficher.pendown()
afficher.write("AFFICHAGE", font = ("Verdana", 14, "normal"))
